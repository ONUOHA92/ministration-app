...
@Component({
  selector: 'app-editor',
  templateUrl: './mineditor.component.html',
  styleUrls: ['./mineditor.component.scss']
})

export class MinEditorComponent implements OnInit {
  ...
  getSongsAndBackup(ministrationId: string): void {
    this.songService.getSongsBackup(ministrationId).subscribe(
      (data: any) => {
