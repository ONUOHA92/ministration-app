...
export class DetailsComponent implements OnInit {
  ...
  getSelectedUser() {
    ...
    this.payloadService.request(`user/find`, { where: { id: this.userid }, limit: 1 }, this.payloadService.TYPE_POST, function (response, status) {
  ...
  public active_jobs: Array<Job> = new Array<Job>();
  ...
  onRemoveAssigned(data: any, schedule: any) {
  ...
  onSubmitAssigned($event: Event) {
    ...
    let json: any = JSON.parse(JSON.stringify(this.assignNewJob))
